...
export const selectedDeck = (selectedDeck) => ({type: types.SELECTED_DECK, selectedDeck})

export const clickedDeckId = (clickedDeckId) => ({type: types.SET_DECK_ID, clickedDeckId})
